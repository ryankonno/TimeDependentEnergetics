...
params = {
    ...
    'muscle': 'SOL', # Specify muscle parameters to be used in simulation
        ...
        'EDL': { 
            ...
            'r_cxb': 0.6 * 0.6177/ 4, # F0l0/s, Maximum heat rate of isometric contraction (fast-type fibre)
            'r_cat': 0.4 * 0.6177/ 4, # F0l0/s, Maximum heat rate of isometric contraction (fast-type fibre)
