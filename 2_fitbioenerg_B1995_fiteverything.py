...
params = {
    ...
    'muscle': 'SOL', # Specify muscle parameters to be used in simulation
        ...
        'SOL': {
            ...
            'V_max_oxphos':  3.5, # mM/s, Vicini 2000... TBD
        ...
        'EDL': { 
            ...
            'V_max_oxphos': 3.5/2, # mM/s, Vicini 2000... TBD
            # Vicini eta l., Model 2
            # 'V_max_oxphos':  0.33, # mM/s, Vicini 2000... TBD
            # 'K_adp': 0.36, # mM, Vicini 2000.... TBD (may need to optimise for this parameter)
            # 'nh': 3.43, # unitless, V/Icini 2000, .... TBD (may need to optimise for this parameter)
...
def f_opt(x):
    ...
    E_init_final = np.trapz(E_tot_scaled, t_vec) # Get final initial energy 
    E_rec_final = np.trapz(recovery_heat_model, t_vec) # Get final recovery energy 
    error_ratio_final = np.linalg.norm(E_init_final /  E_rec_final - 1/2) / np.linalg.norm(E_init_final)
